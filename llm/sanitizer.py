...
from llm.schemas import LocalPatientRecord, SanitizedPrompt, SexEnum
...
class Sanitizer:
    ...
    @staticmethod
    def _relative_time_descriptor(timestamp: datetime, reference: Optional[datetime] = None) -> str:
        """
